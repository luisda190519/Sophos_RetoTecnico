...
CREATE TABLE [Customers] (
    ...
    CONSTRAINT [FK_Customers_AspNetUsers_ApplicationUserId] FOREIGN KEY ([ApplicationUserId]) REFERENCES [AspNetUsers] ([Id])
);
GO
...
CREATE UNIQUE INDEX [IX_Customers_ApplicationUserId] ON [Customers] ([ApplicationUserId]) WHERE [ApplicationUserId] IS NOT NULL;
GO
...
VALUES (N'20230916014349_initial', N'7.0.10');
GO
